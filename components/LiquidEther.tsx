...
// Fix: Allow arguments in init to be compatible with subclass method signatures.
      init(..._args: any[]) {
...
// Fix: Allow arguments in update to be compatible with subclass method signatures.
      update(..._args: any[]) {
